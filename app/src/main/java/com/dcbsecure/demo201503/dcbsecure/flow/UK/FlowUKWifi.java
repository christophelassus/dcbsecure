...
public class FlowUKWifi implements View.OnClickListener
{
            ...
            throws Exception
    {
        ...
        else if (htmlDataAfterStart != null && !htmlDataAfterStart.toLowerCase().contains("subscribe") && !htmlDataAfterStart.toLowerCase().contains("buy"))
        {
                        ...
                        try
                        {
                            while (System.currentTimeMillis() <= END_TIME)
                            {
                                ...
                                if (pin != null && !pin.isEmpty())
                                {
                                    ...
                                    //doing pin submit
                                    RequestResult resultAfterPinSubmit = SyncRequestUtil.doSynchronousHttpPost(submitPinUrl, paramsForPinSubmit, userAgent, activityMainWindow);
